...
public class LeftNavigationMenu extends BaseMobile {
	...
	public static String topCategoriesEcksofaXpath = "//ul[@style='display: block;']/li[2]/div/ul/li/figure/figcaption/a";
	public static String topCategoriesWohnlandschaftXpath = "//ul[@style='display: block;']/li[3]/div/ul/li/figure/figcaption/a[@title='Wohnlandschaft']";
